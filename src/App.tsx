...
const backgrounds = [
  ...
  'https://images.unsplash.com/photo-1615716175455-9a501e3d0d6f?q=80&w=800&auto=format&fit=crop',
...
const templates = [
  ...
  },
  {
    ...
    itemStyle: 'aspect-[4/3]'
  },
  {
    id: 'horizontal',
    name: 'Horizontal Strip',
    layout: 'flex flex-row gap-2 h-48',
    itemStyle: 'flex-1'
  },
  {
    id: 'polaroid',
...
function App() {
  ...
  const capture = useCallback(() => {
    if (webcamRef.current && photos.length < 4) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <div className="relative">
              ...
              >
                <Camera size={20} /> Capture ({photos.length}/4)
              </button>
            </div>
          </div>
          ...
          {/* Result Section */}
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <div ref={resultRef} className="relative bg-white rounded-lg overflow-hidden" style={{ minHeight: '400px' }}>
              <img 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {templates.map((template) => (
              ...
              >
                ...
                <div className={`mt-2 w-full aspect-video bg-gray-100 rounded flex items-center justify-center ${
                  template.id === 'vertical' ? 'flex-col space-y-1' :
                  template.id === 'horizontal' ? 'flex-row space-x-1' :
